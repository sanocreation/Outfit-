"""
Script to generate the reproducible worker/catvton_colab_worker.ipynb Jupyter Notebook.
Follows nbformat v4 structure with all 10 required cells.
"""
import json
...
notebook = {
    ...
    "metadata": {
        "colab": {
            "name": "TRYON_AI_CatVTON_GPU_Worker.ipynb",
            "provenance": [],
            "gpuType": "T4"
        },
        "accelerator": "GPU",
...
output_path = Path(__file__).parent / "catvton_colab_worker.ipynb"
